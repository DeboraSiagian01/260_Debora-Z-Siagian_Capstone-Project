...
Capstone Project
#Modul : Analisis Vaksin Pediatrik AML
#Dataset : GSE2191
...
#Antara dua kondisi biologis (misalnya penderita PAML vs normal)
...
# GPL8300 = Affymetrix Human Genome U95 Version 2 Array
...
gset <- getGEO("GSE2191", GSEMatrix = TRUE, AnnotGPL = TRUE) [[1]]
...
#pData(): metadata sampel
#Kita mengambil kolom ‘treatment:ch1’ yang berisi info vaksin vs
Baseline
...
#p.value = 0.05 -> gen signifikan untuk standar vaksin yang biasanya
0.05
...
theme_minimal() +
ggtitle("Volcano Plot DEG Vaksin Pediatrik AML")
